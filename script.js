        ...
        <div class="crossword">
            ...
            <div class="clues-wrap">
                ...
                <div class="clue-col">
                    ...
                    <p><b>8.</b> One of your favourite games</p>
    ...
    message.innerHTML = `
        <div class="love-letter">
            ...
            <div class="letter-content">
                ...
                <p>
                    I was thining a lot about what to do for your birthday, and I 
                ...
                <p>
                    Anyways, I just wanted to say that I'm reaaaaally glad I met you c: You've become
                    such an important person in my life, and I hope it stays that way forever and ever (and ever).
                    I don't think I'll ever meet someone like you. We have such a good connection,
                    especially in such a short amount of time. I used to think that wasn't even 
                    possible, but my whole life changed because of you, and I'm really grateful for that.
                </p>

                <p>
                    You're really kindhearted, and I hope I can give you a feeling you've never experienced before.
                    I really appreciate you, and I want to do whatever I can to make you feel happy (or
                    is this what guys are suppose dto say? o.o idk). But I really do care about you. Although
                    we might show that we care in different ways, I hope you can still feel that I do.
                </p>

                <p>
                    I look forward to spending more time together and making new memories :3. 
                    Tbh, I have so many things I want to tell you, but I'll save them for when I see you 
                    (also, they don't really fi tbeing written in a birthday letter lol). 
...
function buildGrid() {
    ...
    words.forEach(word => {
        ...
        [...word.answer].forEach((letter, index) => {
            ...
            if (
                word.extract.pos === index + 1
            ) {

                grid[row][col].extractBox =
                    word.extract.box;
...
function updateSecretMessage() {
    ...
    cells.forEach(cell => {
        ...
        const extract =
            cell.querySelector(".extract-number");
        ...
        <div class="music-story">
            ...
            <div class="song-item">
                ...
                <div class="song-content">
                    ...
                    <p>
                        But then I I started thinking about it more. 
...
function toggleSongImage(image) {
    ...
    /*
       Instead of checking image.src,
       we keep track of which image is showing.
    */
